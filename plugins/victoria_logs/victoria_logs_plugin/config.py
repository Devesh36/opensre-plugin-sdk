"""Environment configuration for the victoria_logs integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['VICTORIA_LOGS_URL']

INJECT_ENV_MAP: dict[str, str] = {'url': 'VICTORIA_LOGS_URL', 'tenant_id': 'VICTORIA_LOGS_TENANT_ID'}
