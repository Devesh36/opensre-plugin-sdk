"""Environment configuration for the mongodb integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['MONGODB_CONNECTION_STRING']

INJECT_ENV_MAP: dict[str, str] = {'connection_string': 'MONGODB_CONNECTION_STRING', 'database': 'MONGODB_DATABASE'}
