"""Environment configuration for the tracer_web integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['JWT_TOKEN', 'TRACER_API_URL']

INJECT_ENV_MAP: dict[str, str] = {'jwt_token': 'JWT_TOKEN', 'api_url': 'TRACER_API_URL'}
