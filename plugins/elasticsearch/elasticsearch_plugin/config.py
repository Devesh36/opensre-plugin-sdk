"""Environment configuration for the elasticsearch integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['ELASTICSEARCH_URL']

INJECT_ENV_MAP: dict[str, str] = {'url': 'ELASTICSEARCH_URL', 'api_key': 'ELASTICSEARCH_API_KEY', 'username': 'ELASTICSEARCH_USERNAME', 'password': 'ELASTICSEARCH_PASSWORD'}
