"""Environment configuration for the google_docs integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['GOOGLE_CREDENTIALS_FILE']

INJECT_ENV_MAP: dict[str, str] = {'credentials_file': 'GOOGLE_CREDENTIALS_FILE', 'folder_id': 'GOOGLE_DRIVE_FOLDER_ID'}
