"""Environment configuration for the signoz integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['SIGNOZ_URL']

INJECT_ENV_MAP: dict[str, str] = {'url': 'SIGNOZ_URL', 'api_key': 'SIGNOZ_API_KEY'}
