"""Environment configuration for the opsgenie integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['OPSGENIE_API_KEY']

INJECT_ENV_MAP: dict[str, str] = {'api_key': 'OPSGENIE_API_KEY', 'region': 'OPSGENIE_REGION'}
