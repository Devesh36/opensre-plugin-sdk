"""Environment configuration for the github integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['GITHUB_MCP_URL', 'GITHUB_MCP_COMMAND']

INJECT_ENV_MAP: dict[str, str] = {'auth_token': 'GITHUB_MCP_AUTH_TOKEN'}
