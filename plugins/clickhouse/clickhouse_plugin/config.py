"""Environment configuration for the clickhouse integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['CLICKHOUSE_HOST']

INJECT_ENV_MAP: dict[str, str] = {'host': 'CLICKHOUSE_HOST', 'user': 'CLICKHOUSE_USER', 'password': 'CLICKHOUSE_PASSWORD', 'database': 'CLICKHOUSE_DATABASE'}
