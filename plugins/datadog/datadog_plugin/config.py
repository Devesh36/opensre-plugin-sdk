"""Environment configuration for the datadog integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['DD_API_KEY']

INJECT_ENV_MAP: dict[str, str] = {'api_key': 'DD_API_KEY', 'app_key': 'DD_APP_KEY', 'site': 'DD_SITE'}
