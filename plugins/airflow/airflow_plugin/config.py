"""Environment configuration for the airflow integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['AIRFLOW_BASE_URL']

INJECT_ENV_MAP: dict[str, str] = {'base_url': 'AIRFLOW_BASE_URL', 'username': 'AIRFLOW_USERNAME', 'password': 'AIRFLOW_PASSWORD', 'auth_token': 'AIRFLOW_AUTH_TOKEN'}
