"""Environment configuration for the snowflake integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['SNOWFLAKE_TOKEN', 'SNOWFLAKE_ACCOUNT']

INJECT_ENV_MAP: dict[str, str] = {'token': 'SNOWFLAKE_TOKEN', 'account': 'SNOWFLAKE_ACCOUNT_IDENTIFIER'}
