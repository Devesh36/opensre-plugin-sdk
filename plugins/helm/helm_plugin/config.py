"""Environment configuration for the helm integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['OSRE_HELM_INTEGRATION']

INJECT_ENV_MAP: dict[str, str] = {'helm_path': 'HELM_PATH', 'kube_context': 'HELM_KUBE_CONTEXT', 'kubeconfig': 'HELM_KUBECONFIG'}
