"""Environment configuration for the postgresql integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['POSTGRESQL_HOST']

INJECT_ENV_MAP: dict[str, str] = {'host': 'POSTGRESQL_HOST', 'database': 'POSTGRESQL_DATABASE', 'username': 'POSTGRESQL_USERNAME', 'password': 'POSTGRESQL_PASSWORD'}
