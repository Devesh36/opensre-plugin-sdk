"""Environment configuration for the azure integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['AZURE_LOG_ANALYTICS_WORKSPACE_ID']

INJECT_ENV_MAP: dict[str, str] = {'workspace_id': 'AZURE_LOG_ANALYTICS_WORKSPACE_ID', 'token': 'AZURE_LOG_ANALYTICS_TOKEN'}
