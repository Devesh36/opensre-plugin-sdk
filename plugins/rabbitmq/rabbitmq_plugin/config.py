"""Environment configuration for the rabbitmq integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['RABBITMQ_HOST']

INJECT_ENV_MAP: dict[str, str] = {'host': 'RABBITMQ_HOST', 'username': 'RABBITMQ_USERNAME', 'password': 'RABBITMQ_PASSWORD'}
