"""Bridged tool: get_mariadb_replication_status (from OpenSRE app.tools.MariaDBReplicationTool)."""
...
def get_mariadb_replication_status(**kwargs: Any) -> dict[str, Any]:
    payload = {**_extract_params({}), **kwargs}
    try:
        return delegate_to_opensre(
            module='app.tools.MariaDBReplicationTool',
            attr='get_mariadb_replication_status',
            kwargs=payload,
        )
        ...
        return {"error": f"get_mariadb_replication_status failed: {exc}"}
