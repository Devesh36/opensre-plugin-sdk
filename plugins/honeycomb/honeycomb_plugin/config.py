"""Environment configuration for the honeycomb integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['HONEYCOMB_API_KEY']

INJECT_ENV_MAP: dict[str, str] = {'api_key': 'HONEYCOMB_API_KEY', 'dataset': 'HONEYCOMB_DATASET', 'base_url': 'HONEYCOMB_API_URL'}
