"""Bridged tool: get_hermes_runtime_state (from OpenSRE app.tools.HermesSessionEvidenceTool)."""
...
def get_hermes_runtime_state(**kwargs: Any) -> dict[str, Any]:
    payload = {**_extract_params({}), **kwargs}
    try:
        return delegate_to_opensre(
            module='app.tools.HermesSessionEvidenceTool',
            attr='get_hermes_runtime_state',
            kwargs=payload,
        )
        ...
        return {"error": f"get_hermes_runtime_state failed: {exc}"}
