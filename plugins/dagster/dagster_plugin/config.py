"""Environment configuration for the dagster integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['DAGSTER_ENDPOINT']

INJECT_ENV_MAP: dict[str, str] = {'endpoint': 'DAGSTER_ENDPOINT', 'api_token': 'DAGSTER_API_TOKEN'}
