"""Environment configuration for the splunk integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['SPLUNK_URL']

INJECT_ENV_MAP: dict[str, str] = {'url': 'SPLUNK_URL', 'token': 'SPLUNK_TOKEN'}
