"""Environment configuration for the coralogix integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['CORALOGIX_API_KEY']

INJECT_ENV_MAP: dict[str, str] = {'api_key': 'CORALOGIX_API_KEY', 'base_url': 'CORALOGIX_API_URL'}
