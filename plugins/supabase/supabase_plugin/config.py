"""Environment configuration for the supabase integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['SUPABASE_URL']

INJECT_ENV_MAP: dict[str, str] = {'url': 'SUPABASE_URL', 'service_key': 'SUPABASE_SERVICE_KEY'}
