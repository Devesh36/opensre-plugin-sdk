"""Environment configuration for the vercel integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['VERCEL_API_TOKEN']

INJECT_ENV_MAP: dict[str, str] = {'api_token': 'VERCEL_API_TOKEN', 'team_id': 'VERCEL_TEAM_ID'}
