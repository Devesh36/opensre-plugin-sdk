"""Environment configuration for the prefect integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['PREFECT_API_KEY']

INJECT_ENV_MAP: dict[str, str] = {'api_key': 'PREFECT_API_KEY'}
