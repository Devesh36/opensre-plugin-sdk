"""Environment configuration for the mysql integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['MYSQL_HOST']

INJECT_ENV_MAP: dict[str, str] = {'host': 'MYSQL_HOST', 'database': 'MYSQL_DATABASE', 'username': 'MYSQL_USERNAME', 'password': 'MYSQL_PASSWORD'}
