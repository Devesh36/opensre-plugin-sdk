"""Environment configuration for the azure_sql integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['AZURE_SQL_SERVER']

INJECT_ENV_MAP: dict[str, str] = {'server': 'AZURE_SQL_SERVER', 'database': 'AZURE_SQL_DATABASE', 'username': 'AZURE_SQL_USERNAME', 'password': 'AZURE_SQL_PASSWORD'}
