"""Environment configuration for the mariadb integration (Phase 1)."""
...
GATE_ENV_VARS: tuple[str, ...] = ['MARIADB_HOST']

INJECT_ENV_MAP: dict[str, str] = {'host': 'MARIADB_HOST', 'database': 'MARIADB_DATABASE', 'username': 'MARIADB_USERNAME', 'password': 'MARIADB_PASSWORD'}
